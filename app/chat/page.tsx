...
import getResponse from "@/lib/gemini/gemini";
    ...
    <div className="flex flex-col h-screen p-4 sm:p-6 bg-gray-100 dark:bg-black text-gray-900 dark:text-white">
      ...
      <div className="flex-grow overflow-y-auto mb-6 p-4 bg-white dark:bg-gray-900 rounded-lg shadow-inner">
        <div className="bg-blue-600 dark:bg-blue-500 text-white dark:text-gray-100 rounded-lg p-3 max-w-fit self-start">
          <p>
            Hello! I’m LangChain Assistant, here to help you with any questions
            you have.
          </p>
        </div>
          ...
          {messages.map((msg, index) => (
            <div
              ...
              className={`rounded-lg p-3 max-w-[75%] ${
                msg.role === "user"
                  ? "self-end bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
